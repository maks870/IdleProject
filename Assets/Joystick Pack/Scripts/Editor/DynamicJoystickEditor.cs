...
public class DynamicJoystickEditor : JoystickEditor
{
    ...
    private SerializedProperty isDesktop;

    protected override void OnEnable()
    {
        base.OnEnable();
        moveThreshold = serializedObject.FindProperty("moveThreshold");
        isDesktop = serializedObject.FindProperty("isDesktop");
    }
    ...
    protected override void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(isDesktop, new GUIContent("Desktop", "The distance away from the center input has to be before the joystick begins to move."));
    }
}